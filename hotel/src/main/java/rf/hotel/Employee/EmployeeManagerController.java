...
public class EmployeeManagerController {
    ...
    public Employees getEmployee() {
        ...
        // Get other field values and create an Employee object as needed
    ...
    // Confirm the form and add the employee
    @FXML
    ...
    public void updateEmployee(ActionEvent actionEvent) {if (currentId != 0) {
        try {
