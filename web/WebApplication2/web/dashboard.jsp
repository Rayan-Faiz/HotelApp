...
<head>
    ...
    <style>
        ...
        /* Style for the div containing forms */
        .form-container {
            margin-top: 20px;
        }
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="MyReservationsServlet" method="get" class="dashboard-form">
            <input type="submit" value="My Reservations" class="btn btn-info dashboard-btn">
        </form>
    </div>
